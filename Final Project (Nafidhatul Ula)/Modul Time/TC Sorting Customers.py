...
class TestCustomers(unittest.TestCase): 
    ...
    def test_h_success_sorting_acending(self): 
        ...
        time.sleep(1)
        browser.find_element(By.CSS_SELECTOR,".oxd-table-header-sort").click()
        time.sleep(1)
        browser.find_element(By.XPATH,"//div[@id='app']//div[@role='table']/div[1]/div[@role='row']/div[2]//div[@role='dropdown']/ul[@role='menu']/li[1]").click()
        time.sleep(3)

    def test_i_success_sorting_decending(self): 
        browser = self.browser
        browser.get("https://opensource-demo.orangehrmlive.com/") # buka situs
        time.sleep(3)
        browser.find_element(By.XPATH,"//div[@id='app']/div[@class='orangehrm-login-layout']/div[@class='orangehrm-login-layout-blob']//form[@action='/web/index.php/auth/validate']/div[1]/div//input[@name='username']").send_keys("Admin") # isi email
        ...
        browser.find_element(By.CSS_SELECTOR,".oxd-table-header-sort").click()
        time.sleep(1)
        browser.find_element(By.XPATH,"//div[@id='app']//div[@role='table']/div[1]/div[@role='row']/div[2]//div[@role='dropdown']/ul[@role='menu']/li[2]").click()
        time.sleep(3)
